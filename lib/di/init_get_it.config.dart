...
import 'package:expense_tracker/data/database/dao/wallet_dao.dart' as _i12;
import 'package:expense_tracker/data/database/models/wallets.dart' as _i18;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i12.WalletDao>(() => _i12.WalletDao(gh<_i3.AppDatabase>()));
    gh.factory<_i13.WalletRepository>(
        () => _i14.WalletRepositoryImpl(gh<_i12.WalletDao>()));
    gh.factory<_i15.WalletsBloc>(
        () => _i15.WalletsBloc(gh<_i13.WalletRepository>()));
    gh.factory<_i16.AddTransactionBloc>(() => _i16.AddTransactionBloc(
          gh<_i10.TransactionRepository>(),
          gh<_i13.WalletRepository>(),
          gh<_i5.CategoryRepository>(),
        ));
    gh.factoryParam<_i17.AddWalletBloc, _i18.Wallet?, dynamic>((
      wallet,
      _,
    ) =>
        _i17.AddWalletBloc(
