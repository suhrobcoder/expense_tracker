...
import 'package:expense_tracker/data/database/dao/wallet_dao.dart' as _i11;
import 'package:expense_tracker/data/database/models/wallets.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i10.TransactionRepositoryImpl>(
        () => _i10.TransactionRepositoryImpl(gh<_i9.TransactionDao>()));
    gh.factory<_i11.WalletDao>(() => _i11.WalletDao(gh<_i3.AppDatabase>()));
    gh.factory<_i12.WalletRepository>(
        () => _i13.WalletRepositoryImpl(gh<_i11.WalletDao>()));
    gh.factory<_i14.WalletsBloc>(
        () => _i14.WalletsBloc(gh<_i12.WalletRepository>()));
    gh.factoryParam<_i15.AddWalletBloc, _i16.Wallet?, dynamic>((
      wallet,
      _,
    ) =>
        _i15.AddWalletBloc(
          gh<_i12.WalletRepository>(),
          wallet,
        ));
    return this;
  }
