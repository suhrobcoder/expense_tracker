...
import 'package:expense_tracker/data/database/dao/transaction_dao.dart' as _i13;
import 'package:expense_tracker/data/database/dao/wallet_dao.dart' as _i17;
import 'package:expense_tracker/data/database/models/budgets.dart' as _i22;
import 'package:expense_tracker/data/database/models/wallets.dart' as _i25;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factoryParam<_i11.CreateCategoryBloc, dynamic, dynamic>((
      category,
      _,
    ) =>
    ...
    gh.factory<_i13.TransactionDao>(
        () => _i13.TransactionDao(gh<_i3.AppDatabase>()));
    gh.factory<_i14.TransactionRepository>(
        () => _i15.TransactionRepositoryImpl(gh<_i13.TransactionDao>()));
    gh.factory<_i16.TransactionsBloc>(
        () => _i16.TransactionsBloc(gh<_i14.TransactionRepository>()));
    gh.factory<_i17.WalletDao>(() => _i17.WalletDao(gh<_i3.AppDatabase>()));
    gh.factory<_i18.WalletRepository>(
        () => _i19.WalletRepositoryImpl(gh<_i17.WalletDao>()));
    gh.factory<_i20.WalletsBloc>(
        () => _i20.WalletsBloc(gh<_i18.WalletRepository>()));
    gh.factoryParam<_i21.AddBudgetBloc, _i22.Budget?, dynamic>((
      budget,
      _,
    ) =>
        _i21.AddBudgetBloc(
          gh<_i5.BudgetRepository>(),
          gh<_i18.WalletRepository>(),
          gh<_i9.CategoryRepository>(),
          budget,
        ));
    gh.factory<_i23.AddTransactionBloc>(() => _i23.AddTransactionBloc(
          gh<_i14.TransactionRepository>(),
          gh<_i18.WalletRepository>(),
          gh<_i9.CategoryRepository>(),
        ));
    gh.factoryParam<_i24.AddWalletBloc, _i25.Wallet?, dynamic>((
      wallet,
      _,
    ) =>
        _i24.AddWalletBloc(
